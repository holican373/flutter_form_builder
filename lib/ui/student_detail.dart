...
class StudentDetail extends StatefulWidget {
  ...
  StudentDetail({@required this.studentId, @required this.studentName});
...
class _StudentDetailState extends State<StudentDetail> {
  ...
  FutureBuilder _buildStudent() {
    return FutureBuilder<Student>(
      future: Provider.of<StudentDao>(context, listen: false)
          ...
          return Container(
            child: Column(
              children: <Widget>[
                ...
                student.dob != null
                    ? Text("DOB : ${_format.format(student.dob)}")
                    : Text("DOB : not specified")
              ],
            ),
          );
        } else {
